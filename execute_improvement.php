...
function enhanceWithGemini($html, $url, $type, $traditionalResult, $apiKey) {
    ...
    $prompt = "以下のWebページの{$typeDescription}について、現在のページの実際の内容を引用して具体的な問題点を指摘し、より実践的な改善提案をしてください。
...
【重要】必ず現在のページの実際の内容を引用して具体的な問題点を指摘してください。

以下の形式で回答してください：

## 🔍 現在のページの具体的な問題分析

**現在の{$typeDescription}の状況：**
『実際のページから引用した現在の内容』
...
回答は実践的で具体的な内容にし、マークダウン形式で見やすく整理してください。実際に本番サイトで使用できる具体的なコードと文案を必ず含めてください。現在のページの実際の内容を必ず引用して問題点を明確にしてください。";
...
【重要】必ず現在のページの実際の内容を引用して具体的な問題点を指摘してから改善提案をしてください。
...
**改善後のテキスト文案：**
- タイトル案: 「現在：『実際のタイトル』→ 改善後：『改善タイトル案』」
- メタディスクリプション案: 「現在：『実際のメタディスクリプション』→ 改善後：『改善案』」
- 見出し案: 「現在：『実際の見出し』→ 改善後：『改善見出し案』」
- その他の具体的な文案
...
**測定・評価方法：**
- 改善前後の比較項目（現在の『実際の値』と改善後の期待値）
- 使用すべき分析ツール
- 効果測定の期間と指標

実際に本番サイトで使用できる具体的なコードと文案を必ず含めてください。現在のページの実際の内容を必ず引用して問題点を明確にしてください。";
